...
const subs = [
  ...
  ['https://discover.betterengineer.com/technologies/react/',
   'https://discover.betterengineer.com/technologies/[TECH_SLUG]/'],
  // Breadcrumb structured data (position 3 name; the URL is tokenized by the sub above)
  ['"name":"React Engineers"',                   '"name":"[TECHNOLOGY] Engineers"'],
  // Hero
